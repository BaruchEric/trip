...
describe("M4 acceptance, against captured Nominatim responses", () => {
  ...
  const MENTIONS = [
    { text: "Luohan Temple", atSeconds: 100, dwellMinutes: null, tags: [], kind: "temple" as const, price: [], query: null },
    { text: "Hongya Cave", atSeconds: 272, dwellMinutes: null, tags: [], kind: "landmark" as const, price: [], query: null },
    { text: "Jiefangbei Pedestrian Street", atSeconds: 400, dwellMinutes: null, tags: [], kind: "street" as const, price: [], query: null },
  ];
